...
function PersonelAnaliz() {
    ...
    const [selectedUserId, setSelectedUserId] = useState('1'); // Seçilen kullanıcı id'si
    ...
    return (
        <div>
...

            {
                selectedUserId && (
                    <>
                        <Typography variant="h7" sx={{ marginTop: '1rem', marginBottom: '1rem', color: getPerformanceColor() }}>
                            Performans Durumu: {getPerformanceStatus()}
                        </Typography>

                        <ResponsiveContainer fullWidth height={250}>
