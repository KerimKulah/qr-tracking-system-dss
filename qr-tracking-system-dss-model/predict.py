...
if __name__ == '__main__':
    app.run(debug=True, host='0.0.0.0', port=5000, ssl_context=('vite.crt', 'vite.key'))

# SSL KULLANMIYORSANIZ  app.run(debug=True, host='0.0.0.0', port=5000) ŞEKLİNDE DEĞİŞTİRİN